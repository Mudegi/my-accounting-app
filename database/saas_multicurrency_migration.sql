...
VALUES
  ('free_trial', 'Free Trial', '30-day free access to all features', 0, 0, 'UGX', 30, -1, -1, -1,
...
BEGIN
  ...
  LOOP
    ...
    VALUES (biz.id, trial_plan_id, 'trial', 'monthly', now(), now() + interval '30 days', now() + interval '30 days');

    UPDATE businesses SET subscription_status = 'trial', subscription_ends_at = now() + interval '30 days'
