-- ═══════════════════════════════════════════════════════════════════
-- Global Units of Measure Migration
-- Populates the system with 530+ units from the provided list.
-- ═══════════════════════════════════════════════════════════════════
...
DROP POLICY IF EXISTS "Public read access for units" ON public.units_of_measure;
CREATE POLICY "Public read access for units" ON public.units_of_measure FOR SELECT USING (true);

-- Populate Data
-- We use SELECT DISTINCT ON (code) to handle any duplicate codes in the list
